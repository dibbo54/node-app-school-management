...
//       //"eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjYzNWUyYWNkYWMzMTFxOGM0Mzk5MiIsImlhdCI6MTY2NzE4NTkwMiwiZXhwIjoxNjY3NjE3OTAyfQ.CmSOPQIRra70FGlf5sXB8uGoyC77Hw_M2sL3_FR6yrA"
//       token
//       );
//       //verifyToken
...
exports.getAdminProfileCtrl = AysncHandler(async (req, res) => {
  const admin = await Admin.findById(req.userAuth._id)
    ...
    .populate("programs")
    .populate("yearGroups").populate('teachers').populate('students');
  if (!admin) {
